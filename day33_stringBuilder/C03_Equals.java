...
public class C03_Equals {
	...
	public static void main(String[] args) {
		...
		//eger tum karakterler ayni ise sinuc olarak 0 doner
		...
		//System.out.println(sb1.compareTo(str)); kabul etmiyor compare String icin kullanilamaz 
		
		//System.out.println(sb1=="Java"); kabul etmiyor 
