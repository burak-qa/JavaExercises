...
public class ReusableMethodsExcel {
    ...
    public static Cell cellGet(String path, String sayfaIsmi, int satirIndex, int hucreIndex){
        Cell cell=null;
        try {
    ...
    public static Map<String,String> mapMake(String path, String sayfaAdi) {
