...
public class C05_JsExecuterScrolIntoView extends TestBase {
    ...
    public void scroolJsExecutor(){
        ...
        WebElement roomSearchLink=driver.findElement(By.xpath("(//a[@class='btn-custom'])[2]"));

    //3,. adim ilgili script ve argument ile jse.executeScript() calistir

        jse.executeScript("arguments[0].scrollIntoView(true);", roomSearchLink);
        jse.executeScript("arguments[0].click();", roomSearchLink);
    }
}
