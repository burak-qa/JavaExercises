    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("   ***   ");
        kubBirFazlaTekFunction(list);
        System.out.println();
        System.out.println("   ***   ");
        kareKokCitfFunctional(list);
        System.out.println();
        System.out.println("   ***   ");
        maxElfunction(list);
    }
...
//map()--> bir ara islemde kullanilir.elemanları istenen isleme gore degistirmek update etmek icin kullanilir.
    ...
    public static void kubBirFazlaTekFunction(List<Integer>list){
        list.
                stream().
                filter(t->t%2==1).
                map(t->(t*t*t)+1).
    ...
    public static void kareKokCitfFunctional(List<Integer>list){
        list.
                stream().
    ...
    public static void maxElfunction(List<Integer>list){
      Optional<Integer> maxEl= list.stream().reduce(Math::max);
        ...
        //reduce() --> azaltmak .. bir cok datayi tek bir dataya (max min crp top vs. islemlerde)
