		...
		// Java run time bir programdir
			...
			//C02.staticVariableIsmi ve C02.staticMethodIsmi() yazmamiz yeterli olur
				...
				System.out.println("obje1 icin x : "+ obje1.x +", obje1 icin y : " + C02.y);
				 ...
				 System.out.println("obje 2 olusturulduktan ve islemden sonra obje1'in " + "x : "+obje1.x+ "y : "+C02.y);
				 ...
				 System.out.println("obje3'den sonra obje1'in y: "+ C02.y);
				 System.out.println("obje3'den sonra obje2'in y: "+ C02.y);
				 System.out.println("obje3'den sonra obje3'in y: "+ C02.y);
